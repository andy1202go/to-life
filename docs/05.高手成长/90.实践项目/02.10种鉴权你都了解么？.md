---
date: 2022-09-05 17:38:53
titleTag: 转载
title: 一口气说出前后端 10 种鉴权方案~
---

在介绍鉴权方法之前，我们先要了解的是：`什么是认证、授权、鉴权、权限控制`以及他们之间的关系，有了他们做铺垫，那么我们才能做到从始至终的了解透彻 ~

![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsB96AAyUpOz2VAH9YL3avmRlBcgtsdoEq6RpHiagsnTMFuJOzxtGfYcg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsMMIhHcTQlgOaaibvhV6Hqickgy9ib3NuWLMeSYmRNBRTVXhTvoU0jEfWQ/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsZh9icF1hRYicQnQTibLBdh74eLc6RfhRjee8JOHTL4qEA6B6CCZ0meiarw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)HTTP基本鉴权
...
2. - 由于是基于 HTTP 传输，所以它在网络上几乎是裸奔的，虽然它使用了 Base64 来编码，但这个编码很容易就可以解码出来。
   - 即使认证内容无法被解码为原始的用户名和密码也是不安全的，恶意用户可以再获取了认证内容后使用其不断的享服务器发起请求，这就是所谓的重放攻击。

3. **无法主动注销**：

4. - 由于 HTTP 协议没有提供机制清除浏览器中的 Basic 认证信息，除非标签页或浏览器关闭、或用户清除历史记录。
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsF3wEeHI4rPXO8zCZJJScrxeQicfEtKJLE6rwz4zibRiaG1ydKiau9fpFGw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)Session-Cookie的认证流程图
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsRiaA39XibEqCLzXR578OupnWNNrIaMg0VzHgZBeQII5wOABibUiaxLmP1g/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)Token的认证流程图
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsaEIavsczpN45k2ib5ic7rh7bvuYSOdiccKo7T61pXpRibgve2mToETagRA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)RefreshToken的认证流程图
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQms83CicfZte1aaiaQy2RFexticO9lCCofwfyon5EbY0iaorN6ptdALA9DEHg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)JWT的认证流程图的副本
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsVeKiaHnDqk6I92NghO93ibMMMXOCFN150YCLfyQ1N81Mdf9tJyrX9nzQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
1. **客户端：**
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsDbanRIRmKIYNt6QHSSER6zOPEg3ia6fdug1wY0OfeQJsiaibQxydqsCnA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
2. **授权服务器：**
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsIDM275v1ZFs1p8ia7rlEG0Z09r7zBjrDbdTOSib4xkhviaHU1HNiasPGdA/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
3. **网站 A 服务器：**
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsxyU1y4OZzmgZhVicK2C2LypOHPZgEJYZmhN3W9iaONYQMAoKjHte7icUg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
4. **授权服务器：**
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsoDApeJfialgkAoFEEMYO6s3mWqudicWcXaSGNAnQiaJdp0fnJfNJhyicuw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
2. **授权服务器：**
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsjHLrAvicyXA8Co5ZmIA1mNxo5XL3ECHqfBdJ0l0NEJsn6diaXfEOduww/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)前端鉴权
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsKfcs8UyX9XNPHrn6BFruUgzaP4b7zmvtq2YkjrNP92iaYcfbA4mEs8g/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsHia3bUkfQL5BlCFPMU9SHia1WNdc51lWqVRD6icAdHo5tdwb0GUmILC4g/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsEMzx8cn4qpvfDVictSO4RticzIfpDkY8fSQB0dFWwt5Xj8eCkwV9TqzQ/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)扫码登录的认证流程图的副本
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/19cc2hfD2rD20xWedTpIzI9ia6OwicdQmsKhCxdgc3ZgPUz9UQYSW8SHgfM6gU6k0TV5wTQwibC6DajD5WMysxmUw/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1)
...
- [一口气说出前后端 10 种鉴权方案~](https://mp.weixin.qq.com/s/eb-JaNF4XOotEiif2FpjZw)